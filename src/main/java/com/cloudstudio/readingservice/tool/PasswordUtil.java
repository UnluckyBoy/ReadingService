...
public class PasswordUtil {
     ...
     * @return
     */
    public static String  encode(String key,String PwdStr){
        byte[] byteKey = BytetoString(key);
        byte[] pwdKey = PwdStr.getBytes();
        try {
            //生成密钥
            SecretKey deskey = new SecretKeySpec(byteKey, "DESede");//DESede
            //加密
     ...
     * @return
     */
    public static String decode(String key, String desPwd){
